             ...
             <div class="form-row align-items-center">
                <form className="form-group row">
                    ...
                    <div className="col-auto">
                        <input placeholder="Add Event" type="text" id="event-input" className = "form-control" value={task.description} onChange={(e)=> setTask({description : e.target.value, done : false})}/>  
                    </div>
